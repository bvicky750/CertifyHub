...
const VerifyCertificate = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 text-slate-800"
            />
          </div>
          <button
            type="submit"
            disabled={loading}
            className="px-8 py-3 rounded-xl font-bold text-xs text-white bg-brand-600 hover:bg-brand-700 shadow-md shadow-brand-600/20 transition disabled:opacity-50"
          >
      ...
      {result && (
        <div className="bg-white rounded-3xl border border-emerald-200 shadow-2xl p-6 sm:p-10 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-1">
              <span className="text-slate-400 uppercase font-semibold text-[10px]">Student Scholar</span>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-1">
              <span className="text-slate-400 uppercase font-semibold text-[10px]">Course Completed</span>
              <p className="text-base font-bold text-slate-900 flex items-center space-x-2">
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-1">
              <span className="text-slate-400 uppercase font-semibold text-[10px]">Certificate Number</span>
              <p className="text-sm font-mono font-bold text-slate-900">{result.certificate_number}</p>
            </div>

            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-1">
              <span className="text-slate-400 uppercase font-semibold text-[10px]">Verification Code</span>
              <p className="text-sm font-mono font-bold text-slate-900">{result.verification_code}</p>
            </div>

            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-1">
              <span className="text-slate-400 uppercase font-semibold text-[10px]">Issue Date</span>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-1">
              <span className="text-slate-400 uppercase font-semibold text-[10px]">Issuing Body</span>
              <p className="text-sm font-semibold text-slate-800 flex items-center space-x-2">
                <Award className="w-4 h-4 text-amber-500" />
                <span>{result.issuing_organization}</span>
              </p>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-slate-100 flex justify-end">
            <a
              href={`http://localhost:5000/api/certificates/${result.certificate_number}/pdf`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center space-x-2 px-5 py-2.5 rounded-xl text-xs font-bold text-white bg-brand-600 hover:bg-brand-700 shadow-sm transition"
            >
      ...
      {/* Error state */}
      {errorMsg && (
        <div className="bg-white rounded-3xl border border-red-200 p-8 text-center space-y-3 shadow-lg">
